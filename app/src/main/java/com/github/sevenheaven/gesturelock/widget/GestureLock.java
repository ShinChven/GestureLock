package com.github.sevenheaven.gesturelock.widget;
...
/**
 * credits to <a href="https://github.com/7heaven/GestureLock">GestureLock</a> of 7heaven<p>
 * edit by ShinChven
 */
public class GestureLock extends RelativeLayout {
        ...
        if (touchable) {
            switch (event.getActionMasked()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (GestureLockUtils.isDrawTrack(getContext())) {
                        invalidate();
                    }
                    break;
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (gesturesContainer[0] != -1) {
                        ...
                        int count = 0;
                        for (int i = 0; i < gesturesContainer.length; i++) {
                            if (gesturesContainer[i] < 0) {
                                break;
                            }
                            count++;
                        }

                        if (MATCHED && count != defaultGestures.length) {
                            MATCHED = false;
                        }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (gesturePath != null) {
            if (GestureLockUtils.isDrawTrack(getContext()) || !MATCHED) {
